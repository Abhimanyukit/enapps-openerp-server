...
class ConnectionPool(object):
    ...
    def __repr__(self):
        ...
        return "ConnectionPool(id=%s/used=%d/count=%d/max=%d)" % (self._id, used, count, self._maxconn)
...
class Connection(object):
    ...
    def cursor(self, serialized=True):
        ...
        self.cr = Cursor(self._pool, self.dbname, serialized=serialized)
        return self.cr
