...
class ir_sequence(openerp.osv.osv.osv):
    ...
    _columns = {
        ...
        'number_next': openerp.osv.fields.integer('Next Number',
                                                required=True,
                                                help='Next number originally set or reset for this sequence'),
        'number_next_actual': openerp.osv.fields.function(_get_number_next_actual,
                                                        type='integer',
                                                        required=True,
                                                        string='Actual Next Number',
                                                        help='Next number that will actually be used.'
                                                        ' Will be zero for new sequence.'),
        'prohibit_number_next_change': openerp.osv.fields.boolean('Prohibit change of Next Number',
                                                                help='Changing next number can wreak havoc on sequences.'
                                                                ' Checking this option will prevent accidental changes.'),
        'prohibit_number_next_lower': openerp.osv.fields.boolean('Prohibit lower value for Next Number',
