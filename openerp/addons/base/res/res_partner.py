...
class res_partner(osv.osv):
    ...
    def _get_default_partner_address_details(self, cr, uid, ids, name, args, context=None):
        result = {}
        for address_id in ids:
            res = {}
            cr.execute("""SELECT city, function, name, phone, mobile, country_id, email
    ...
    _columns = {
        ...
        'city': fields.function(_get_default_partner_address_details,
                                            method=True,
        ...
        'function': fields.function(_get_default_partner_address_details,
                                            method=True,
                                            multi='defaultaddress',
                                            store=False,
                                            string="function",
        ...
        'subname': fields.function(_get_default_partner_address_details,
                                            method=True,
                                            multi='defaultaddress',
                                            store=False,
                                            string="Contact Name",
        ...
        'phone': fields.function(_get_default_partner_address_details,
                                            method=True,
                                            multi='defaultaddress',
                                            store=False,
                                            string="Phone",
        ...
        'mobile': fields.function(_get_default_partner_address_details,
                                            method=True,
                                            multi='defaultaddress',
                                            store=False,
                                            string="Mobile",
        ...
        'country': fields.function(_get_default_partner_address_details,
                                            method=True,
                                            multi='defaultaddress',
                                            store=False,
                                            string="Country",
        ...
        'email': fields.function(_get_default_partner_address_details,
                                            method=True,
                                            multi='defaultaddress',
                                            store=False,
                                            string="E-mail",
...
#        'company_id': fields.related('partner_id','company_id',type='many2one',relation='res.company',string='Company', store=True),
    ...
    def name_get(self, cr, user, ids, context=None):
        if context is None:
            context = {}
        fields_to_read = context.get('fields_to_read') or ['name','zip','country_id', 'city','partner_id', 'street', 'ref', 'state_id']
        if not len(ids):
            return []
        res = []
    ...
    def name_search(self, cr, user, name, args=None, operator='ilike', context=None, limit=100):
        ...
        if not name:
            ...
            if context.get('contact_display', 'contact') == 'partner_address':
                fields = ['partner_id', 'ref', 'name', 'street', 'zip', 'state_id']
            else:
