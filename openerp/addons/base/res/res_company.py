...
class res_company(osv.osv):
    ...
    _columns = {
        ...
        'rml_footer2': fields.function(_get_bank_data, type="char", string='Bank Accounts Footer', size=250, store=True, help="This field is computed automatically based on bank accounts defined, having the display on footer checkbox set."),
        'rml_header': fields.text('RML Header', required=True),
        'rml_header2': fields.text('RML Internal Header', required=True),
        'rml_header3': fields.text('RML Internal Header', required=True),
        'logo': fields.binary('Logo'),
        'logo_web': fields.function(_get_thumbed_image, method=True, string='Web_logo', type='binary', store=True),
    ...
    def compress_image(self, img_str):
        ...
        small_logo = Image.open(cStringIO.StringIO(base64.decodestring(img_str)))
